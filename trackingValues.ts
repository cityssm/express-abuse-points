 ...
 */
export function isIP4AddressWithPort(ipAddress: string): boolean {
 ...
 */
export function getIP(request: Partial<Request>): string {
  return request.ip ?? ''
}
 ...
 * @returns The IP address, if available.
 */
export function getXForwardedFor(request: Partial<Request>): string {
